...
session_start();
$number = '7219439890'; // Replace with the actual phone number you want to use.

// Prepare and execute a query to get the order amount using the phone number
$select_order_amount = $conn->prepare("SELECT total_price FROM orders WHERE number = ?");
$select_order_amount->execute([$number]);

// Fetch the order amount
if ($row = $select_order_amount->fetch(PDO::FETCH_ASSOC)) {
    $order_amount = $row['total_price'];
} else {
    $order_amount = 0; // Default to 0 if the order is not found
}
                                    ...
                                    <div class="payment-info">
                                        ...
                                        <div class="login-tab">
                                            <div class="user-login">
                                                ...
                                                <a class="confirm-btn cod" href="successPage.php">CONTINUE</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
