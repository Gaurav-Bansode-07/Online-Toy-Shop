   ...
   <script>
       $(document).ready(function () {
           $(".qty").change(function () {
               ...
               var productPrice = parseFloat(form.find('.price').text().replace('$', '').replace('/-', ''));
               var quantity = parseInt($(this).val());
               var totalAmount = productPrice * quantity;
               form.find('.sub-total span').text('$' + totalAmount.toFixed(2) + '/-');
           });
           ...
           $(".update_qty").click(function (event) {
               ...
               var newQuantity = form.find('.qty').val();

               // You can perform the cart update logic here (AJAX call to the server).
               // Assuming you have a function to update the cart, you can call it here.
